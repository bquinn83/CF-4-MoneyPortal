...
namespace MoneyPortal.ViewModels
{
    ...
    {
        [Required, Display(Name = "First Name"), StringLength(100, ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 2)]
        public string FirstName { get; set; }
        [Required, Display(Name = "Last Name"), StringLength(100, ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 2)]
        public string LastName { get; set; }
